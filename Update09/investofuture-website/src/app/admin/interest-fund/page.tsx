...
You can copy the complete code for the "Interest Fund" page from the block below.

**File Path:** `src/app/admin/interest-fund/page.tsx`
...
function FundEditorInternal() {
    ...
    const getStorageKey = (userId: string) => `interest-fund_${userId}`;
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            ...
            toast({
                title: "Changes Saved",
                description: `Interest fund data for ${foundUser.personalInfo.fullName} has been saved permanently in this browser.`,
            });
        } catch (error) {
