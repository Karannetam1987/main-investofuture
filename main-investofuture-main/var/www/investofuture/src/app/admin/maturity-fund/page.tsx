...
const mockFundData: { [key: string]: MaturityFund } = {
    "INF001": {
...
function FundEditor() {
    ...
    const handleSaveChanges = async () => {
        ...
        toast({
            title: "Changes Saved",
            description: `Maturity fund data for ${foundUser.personalInfo.fullName} has been saved.`,
        });
    };
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-6 pt-4 border-t">
                    <h3 className="text-xl font-semibold text-secondary font-headline">
                        Editing maturity fund for: <span className="text-primary">{foundUser.personalInfo.fullName} ({foundUser.id})</span>
                    </h3>
