      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Logo />
            <p className="mt-4 text-sm text-muted-foreground">© {new Date().getFullYear()} InvestoFuture. All rights reserved.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2 text-sm text-muted-foreground">
              <a href="mailto:support@investofuture.com" className="hover:text-foreground transition-colors">support@investofuture.com</a>
              <a href="tel:+1234567890" className="hover:text-foreground transition-colors">(123) 456-7890</a>
            </div>
          </div>
          <div>
            ...
            <div className="mt-4 flex gap-4 text-muted-foreground">
              {socialLinks.map((social) => (
                <Link key={social.name} href={social.href} className="hover:text-foreground transition-colors">
                  {social.icon}
